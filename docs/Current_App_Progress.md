...
### Detection Engine
- [x] 5-Phase Composite Scoring (signal strength, breadth, sustained, context divergence, novelty persistence)
- [x] 4/4 attack detection at 8.5% FP rate (250 users, 485 days, 4.2M daily events)
...
### Temporal Analysis
- [x] Weekly behavioral snapshots (19 weeks analysis window)
...
| Attack User | Campaign | Duration | Composite Score | Rank (/250) | Status |
|-------------|----------|----------|----------------|-------------|--------|
| USR-118 | Salt Typhoon (Telecom) | 100 days | 51.3 | #1 | DETECTED |
| USR-156 | Insider Threat | 8 months | 46.2 | #2 | DETECTED |
| USR-234 | Slow APT (C2 Beacon) | 180 days | 19.4 | #7 | DETECTED |
| USR-042 | Volt Typhoon (LOTL) | 115 days | 13.7 | #24 | DETECTED |
...
3. **Multi-Phase Composite Scoring**: 5 independent detection phases — no single evasion defeats all
